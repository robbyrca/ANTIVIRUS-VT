...
`FileReportV1.py`—> en este codigo python lo que hacemos es mandar el ID del archivo, recibir un response code, mover el archivo correspondiente y hacer el registro en la base de datos donde se dividiran en archivos o en quarentena, donde tendran dos tablas con su respectivo Nombre (file_name) y su ruta (Path).
